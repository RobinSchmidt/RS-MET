...
bool samplerEngineUnitTest()
{
  ...
  //  generated by the sampler. Hand-write some sfz files using different styles. At the moment, it 
  //  seems that parsing fails when there are two whitespaces between the opcodes
