...
void modalReverb()
{
  ...
  // Lx = Ly = Lz = 5, using fMax = 500 produces an actual number of around 1200 modes and the 
  // predicted number is around 1900. That's a pretty bad approximation! For fMax = 1000: 
