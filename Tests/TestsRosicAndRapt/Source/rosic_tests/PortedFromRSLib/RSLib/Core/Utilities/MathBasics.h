#ifndef RS_MATHBASICS_H
#define RS_MATHBASICS_H
...
namespace RSLib
{
  ...
  RS_INLINE rsInt32 rsClippedSum(rsInt32 a, rsInt32 b,
  ...
  Overflow is avoided by using 64-bit addition internally. */
  RS_INLINE rsInt32 rsClippedDifference(rsInt32 a, rsInt32 b,
    rsInt32 min = RS_MIN(rsInt32), rsInt32 max = RS_MAX(rsInt32));
