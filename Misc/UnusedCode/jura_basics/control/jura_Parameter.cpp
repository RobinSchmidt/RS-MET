...
Parameter::Parameter(CriticalSection *criticalSectionToUse, const String& newName, 
  double newMinValue, double newMaxValue, double newInterval, double newDefaultValue, int newScaling) 
{
  jassert(!(newMinValue >= newMaxValue));                      // would result in zero or negative range
