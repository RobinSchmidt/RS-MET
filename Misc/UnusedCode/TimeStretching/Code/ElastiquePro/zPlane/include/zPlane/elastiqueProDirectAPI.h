////////////////////////////////////////////////////////////////////////////////////
//     /*! \file elastiqueProDirectAPI.h: \brief interface of the CElastiqueProDirectIf class. */
//
...
//  CVS INFORMATION
//
//  $RCSfile: elastiqueProDirectAPI.h,v $
//  $Author: flea $
...
#if !defined(__libElastiqueProDirectIf_HEADER_INCLUDED__)
...
public:
     ...
     */
    static int      CreateInstance (CElastiqueProDirectIf*& cCElastique, int iNumOfChannels, float fSampleRate, _elastiquePro_proc_mode eMode);
    ...
    *
    * @return virtual int  : returns number of processed frames
    */
    ...
    *
    * @return virtual int  : returns the number of frames to be ommitted
     */
     ...
     * @param iNumOfInFrames :  the number of input frames
     * @param ppOutSampleData : double pointer to the output buffer of samples [channels][samples]
     * @param iPreferredOutSamples : number of preferred output samples
     *
     * @return virtual int  : returns number of processed frames
     */
    virtual int     PreProcessData(float** ppInSampleData, int iNumOfInFrames, float** ppOutSampleData, int iPreferredOutSamples = 0) = 0;
 ...
 /*!
     ...
     *
     * @return virtual int  : returns the number of frames returned
     */
     ...
     *
     * @return virtual int  : returns the number of process calls required
     */
    ...
    * @param fMinPitchFactor   : the minimum pitch factor to be used
    *
    * @return virtual int : returns number of frames
    */
    virtual int     GetMaxFramesNeeded(float fMinStretchFactor = 0.025, float fMinPitchFactor = 4.0) = 0;
     ...
     * @param bUsePitchSync: synchronizes timestretch and pitchshifting (default is set to _FALSE in order to preserve old behavior, see documentation for V2.1)
     *
     ...
     *
     * @return int  : returns the current input time position 
     *
     */
     ...
     * 
     * @param fShiftFactor: The envelope shift factor.
     * 
     * \@return int: returns some error code otherwise NULL 
     * 	 
     */
     ...
     * 
     * @param iOrder: Sets the order of the spectral envelope estimation
     * 
     * @returns int: returns some error code otherwise NULL 
     * 	 
     */
...
#endif // #if !defined(__libElastiqueProDirectIf_HEADER_INCLUDED__)
