#ifndef RS_FUNCTIONOBJECTS_H
#define RS_FUNCTIONOBJECTS_H
...
namespace RSLib
{
  ...
  */
  ...
  class RSLib_API UnivariateScalarFunction  
  {
  ...
  class RSLib_API UnivariateScalarFunctionViaPointer : public UnivariateScalarFunction  
  {
  ...
  */
  ...
  class RSLib_API Polynomial : public UnivariateScalarFunction  
  {
  ...
  */
  ...
  class RSLib_API MultivariateScalarFunction  
  {
  ...
  */
  ...
  class RSLib_API MultivariateErrorFunction  
  {
  ...
  public:
    ...
    /** Computes an output number from a given input Vector. */
    virtual double getValue(rsVectorDbl p) = 0;
  ...
  */
  ...
  class RSLib_API QuadraticTestErrorFunction : public MultivariateErrorFunction
  {
  ...
  public:
    ...
    virtual double getValue(rsVectorDbl p) { return  0.5*p*(A*p) - b*p + c; }
  ...
  */
  ...
  class RSLib_API MultivariateVectorFunction  
  {
