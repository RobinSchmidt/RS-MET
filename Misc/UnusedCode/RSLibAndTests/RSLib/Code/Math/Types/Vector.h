...
namespace RSLib
{
  ...
  */
  ...
  typedef rsVector<double> RSLib_API rsVectorDbl;
  ...
  // somewhere else):
  RSLib_API rsVectorDbl rsLinearRangeVector(     int N, double min, double max);
  RSLib_API rsVectorDbl rsExponentialRangeVector(int N, double min, double max);
  RSLib_API rsVectorDbl rsRandomVector(          int N, double min, double max, int seed = 0);
  */
