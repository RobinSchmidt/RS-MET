#ifndef RS_FILTERCOEFFICIENTCONVERTER_H
#define RS_FILTERCOEFFICIENTCONVERTER_H
...
namespace RSLib
{
  ...
  */
  ...
  public:
    ...
    static void polesAndZerosToBiquadCascade(rsComplexDbl *poles, int numPoles, 
      rsComplexDbl *zeros, int numZeros, double *b0, double *b1, double *b2, double *a1, 
      double *a2, bool lastStageIsFirstOrder);

    static void polesAndZerosToBiquadCascade(rsComplexDbl *poles, rsComplexDbl *zeros, int order,                                        
      double *b0, double *b1, double *b2, double *a1, double *a2);
      // should this function replace the function above? maybe, we should include a global gain k
      // as input variable?
    ...
    static double getBiquadMagnitudeAt(double b0, double b1, double b2, double a1, double a2, 
      double omega);
    ...
    static void normalizeBiquadStages(double *b0, double *b1, double *b2, double *a1, double *a2, 
      double omega, int numStages, double gainFactor = 1.0);
