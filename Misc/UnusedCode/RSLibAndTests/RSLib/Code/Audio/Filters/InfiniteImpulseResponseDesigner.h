#ifndef RS_INFINITEIMPULSERESPONSEDESIGNER_H
#define RS_INFINITEIMPULSERESPONSEDESIGNER_H
...
namespace RSLib
{
  ...
  */
  ...
  class RSLib_API rsInfiniteImpulseResponseDesigner
  {
  ...
  public:
    ...
    ripple settings are taken into account. It calls setLowerFrequency and setUpperFrequency 
    (which you also may use yourself alternatively) */
