...
namespace RSLib
{
  ...
  \todo rename into rsBiquad

  */

  class RSLib_API rsBiquad
  {
  ...
  */
  ...
  class rsBiquadMonoDF1 : public rsBiquad
  {
  ...
  public:
    ...
    RS_INLINE void getSampleInPlace(double &inOut);

    /** Calculates a single filtered output-sample. */
    RS_INLINE double getSample(double in);

    /** Calculates a single filtered output-sample. */
    RS_INLINE float getSample(float in);
  ...
  RS_INLINE void rsBiquadMonoDF1::getSampleInPlace(double &inOut)
  {
    doubleA tmp = inOut;
  ...
  RS_INLINE double rsBiquadMonoDF1::getSample(double in)
  {
    doubleA tmp;
  ...
  RS_INLINE float rsBiquadMonoDF1::getSample(float in)
  {
  ...
  This class implements a biquad filter which realizes the difference equation:
  ...
  */
  ...
  class rsBiquadStereoDF1 : public rsBiquad
  {
  ...
  public:
    ...
    /** Calculates one output stereo sample-frame at a time. */
    RS_INLINE void getSampleFrameStereo(float *inOutL, float *inOutR);
  ...
  RS_INLINE void rsBiquadStereoDF1::getSampleInPlace(double &inOut)
  {
    doubleA tmp = inOut;

    tmp = (b0*tmp+TINY) + (b1*lx1 + b2*lx2) + (a1*ly1 + a2*ly2); 
          // parentheses facilitate out-of-order execution
  ...
  RS_INLINE double rsBiquadStereoDF1::getSample(double in)
  {
    doubleA tmp;
  ...
  RS_INLINE float rsBiquadStereoDF1::getSample(float in)
  {
    return (float) getSample((double) in);
  }

  RS_INLINE void rsBiquadStereoDF1::getSampleFrameStereo(double *inOutL, double *inOutR)
  {
    doubleA tmp;
  ...
  // get rid of this pesky code duplication
  RS_INLINE void rsBiquadStereoDF1::getSampleFrameStereo(float *inOutL, float *inOutR)
  {
    doubleA tmp;
  ...
  note the positive sign of the feedback part, as opposed to negative sign seen in many DSP 
  textbooks - this has been chosen to allow for better potential for parallelization.
  (maybe measure and if isn't faster, get rid of this and use standard convention)

  ...performance tests indicate that DF1 seems to be more efficient [verify this]

  */

  class rsBiquadStereoDF2 : public rsBiquad
  {
  ...
  RS_INLINE double rsBiquadStereoDF2::getSample(double in)
  {
    double w, y;
  ...
  RS_INLINE void rsBiquadStereoDF2::getSampleFrameStereo(double *inOutL, double *inOutR)
  {
    double w;
  ...
  */
  ...
  class RSLib_API rsBiquadDesigner
  {
  ...
  public:
    ...
    static RS_INLINE void makeBypassBiquad(double& b0, double& b1, double& b2, double& a1,
                                        double& a2);
    ...
    static RS_INLINE void calculateSineAndCosine(double& sinResult, double& cosResult,
    ...
    static RS_INLINE void calculateFirstOrderLowpassCoeffs(double& b0, double& b1, double& b2,
    ...
    method. */
    static RS_INLINE void calculateFirstOrderLowpassCoeffsBilinear(double& b0, double& b1, double& b2,
      double& a1, double& a2, const double& oneOverSampleRate, const double& frequency);
    ...
    static RS_INLINE void calculateCookbookLowpassCoeffs(double& b0, double& b1, double& b2,
      double& a1, double& a2, const double& oneOverSampleRate, const double& frequency,
      const double& q);

    /** Calculates the coefficients for a one-pole highpass filter according to the formula from
    "The Scientist and Engineer's Guide to Digital Signal Processing". */
    static RS_INLINE void calculateFirstOrderHighpassCoeffs(double& b0, double& b1, double& b2,
      double& a1, double& a2, const double& oneOverSampleRate, const double& frequency);

    /** Calculates the coefficients for a one-pole highpass filter by the bilinear transform
    method. */
    static RS_INLINE void calculateFirstOrderHighpassCoeffsBilinear(double& b0, double& b1,
    ...
    Bristow Johnson's Cookbook formula. */
    static RS_INLINE void calculateCookbookHighpassCoeffs(double& b0, double& b1, double& b2,
      double& a1, double& a2, const double& oneOverSampleRate, const double& frequency,
      const double& q);
    ...
    static RS_INLINE void calculateCookbookBandpassConstSkirtCoeffsViaQ(double& b0, double& b1,
      double& b2, double& a1, double& a2, const double& oneOverSampleRate,
      const double& frequency, const double& q);

    /** Calculates the coefficients for a two-pole bandpass type of filter with constant skirt
    gain according to Robert Bristow Johnson's Cookbook formula. */
    static RS_INLINE void calculateCookbookBandpassConstSkirtCoeffsViaBandwidth(double& b0,
    ...
    Bristow Johnson's Cookbook formula. */
    static RS_INLINE void calculateCookbookBandrejectCoeffsViaQ(double& b0, double& b1,
      double& b2, double& a1, double& a2, const double& oneOverSampleRate,
      const double& frequency, const double& q);

    /** Calculates the coefficients for a two-pole bandreject type of filter according to Robert
    Bristow Johnson's Cookbook formula. */
    static RS_INLINE void calculateCookbookBandrejectCoeffsViaBandwidth(double& b0, double& b1,
      double& b2, double& a1, double& a2, const double& oneOverSampleRate,
      const double& frequency, const double& bandwidth);
    ...
    static RS_INLINE void calculateCookbookPeakFilterCoeffsViaQ(double& b0, double& b1, double& b2,
      double& a1, double& a2, const double& oneOverSampleRate, const double& frequency,
    ...
    formula from DAFX?). */
    static RS_INLINE void calculateFirstOrderLowShelvCoeffs(double& b0, double& b1, double& b2,
      double& a1, double& a2, const double& oneOverSampleRate, const double& frequency,
      const double& gainFactor);

    /** Calculates the coefficients for a low shelving type of filter according to Robert
    Bristow Johnson's Cookbook formula. */
    static RS_INLINE void calculateCookbookLowShelvCoeffs(double& b0, double& b1, double& b2,
      double& a1, double& a2, const double& oneOverSampleRate, const double& frequency,
      const double& q, const double& gainFactor);
    ...
    static RS_INLINE void calculateFirstOrderHighShelvCoeffs(double& b0, double& b1, double& b2,
      double& a1, double& a2, const double& oneOverSampleRate, const double& frequency,
      const double& gainFactor);

    /** Calculates the coefficients for a high shelving type of filter according to Robert
    Bristow Johnson's Cookbook formula. */
    static RS_INLINE void calculateCookbookHighShelvCoeffs(double& b0, double& b1, double& b2,
      double& a1, double& a2, const double& oneOverSampleRate, const double& frequency,
      const double& q, const double& gainFactor);
    ...
    DAFX?). */
    static RS_INLINE void calculateFirstOrderAllpassCoeffs(double& b0, double& b1, double& b2,
      double& a1, double& a2, const double& oneOverSampleRate, const double& frequency);

    /** Calculates the coefficients for a second order allpass type of filter according to Robert
    Bristow Johnson's Cookbook formula. */
    static RS_INLINE void calculateCookbookAllpassCoeffs(double& b0, double& b1, double& b2,
      double& a1, double& a2, const double& oneOverSampleRate, const double& frequency,
      const double& q);

    /** Calculates coefficients for a biquad that represents a chain of a first order lowpass and a
    first order highpass filter. */
    static RS_INLINE void calculateLowHighpassChainCoeffs(double& b0, double& b1, double& b2,
    ...
    static RS_INLINE void calculateLowPeakHighMorphCoeffs(double& b0, double& b1, double& b2,
    ...
    frequency. */
    static RS_INLINE void calculatePrescribedNyquistGainEqCoeffs(double& b0, double& b1, double& b2,
      double& a1, double& a2, const double& oneOverSampleRate, const double& frequency,
    ...
    static RS_INLINE void calculateOnePoleCoeffs(double& b0, double& b1, double& b2,
    ...
    static RS_INLINE void calculateOneZeroCoeffs(double& b0, double& b1, double& b2,
    ...
    filters). */
    static RS_INLINE void calculatePolePairCoeffs(double& b0, double& b1, double& b2,
    ...
    static RS_INLINE void calculateZeroPairCoeffs(double& b0, double& b1, double& b2,
  ...
  RS_INLINE void rsBiquadDesigner::makeBypassBiquad(double& b0, double& b1, double& b2, double& a1,
    double& a2)
  {
    b0 = 1.0;
    b1 = 0.0;
  ...
  RS_INLINE void rsBiquadDesigner::calculateSineAndCosine(double& sinResult, double& cosResult,
      const double& frequency, const double& oneOverSampleRate)
  {
  ...
  RS_INLINE void rsBiquadDesigner::calculateFirstOrderLowpassCoeffs(double &b0, double &b1,
  ...
  RS_INLINE void rsBiquadDesigner::calculateFirstOrderLowpassCoeffsBilinear(double &b0, double &b1,
    double &b2, double &a1, double &a2, const double &oneOverSampleRate, const double &frequency)
  {
    ...
    a2                    = 0.0;
    double g              = 0.5*rsSqrt(1.0+a1*a1-2.0*a1); // gain-factor for normalization at DC
    b0                    = g;
    b1                    = g;
    b2                    = 0.0;
  }
  ...
  /*
  RS_INLINE void rsBiquadDesigner::calculateFirstOrderLowpassCoeffsPrescribedNyquist(double &b0, 
    double &b1, double &b2, double &a1, double &a2, const double &sampleRate, 
    const double &frequency)
  {
  ...
  */
  ...
  RS_INLINE void rsBiquadDesigner::calculateCookbookLowpassCoeffs(double& b0, double& b1, 
    double& b2, double& a1, double& a2, const double& oneOverSampleRate, const double& frequency,
      const double& q)
  {
    double sine, cosine;
  ...
  RS_INLINE void rsBiquadDesigner::calculateFirstOrderHighpassCoeffs(double &b0, double &b1,
    double &b2, double &a1, double &a2, const double &oneOverSampleRate, const double &frequency)
  {
    double omega = 2.0 * PI * frequency * oneOverSampleRate;
    double x     = exp(-omega);
  ...
  RS_INLINE void rsBiquadDesigner::calculateFirstOrderHighpassCoeffsBilinear(double &b0, 
    double &b1, double &b2, double &a1, double &a2, const double &oneOverSampleRate, 
    const double &frequency)
  {
    double omegaPreWarped = tan(PI * frequency * oneOverSampleRate);
  ...
  RS_INLINE void rsBiquadDesigner::calculateCookbookHighpassCoeffs(double& b0, double& b1, 
    double& b2,  double& a1, double& a2, const double& oneOverSampleRate, const double& frequency,  
    const double& q)
  {
    double sine, cosine;
  ...
  RS_INLINE void rsBiquadDesigner::calculateCookbookBandpassConstSkirtCoeffsViaQ(double &b0,
    double &b1, double &b2, double &a1, double &a2, const double &oneOverSampleRate,
    const double &frequency, const double &q)
  {
    double sine, cosine;
  ...
  RS_INLINE void rsBiquadDesigner::calculateCookbookBandpassConstSkirtCoeffsViaBandwidth(
    double &b0, double &b1, double &b2, double &a1, double &a2, const double &oneOverSampleRate,
    const double &frequency, const double &bandwidth)
  {
    // to avoid divison by zero:
    double f = rsMax(0.0001, frequency);
    double b = rsMax(0.0001, bandwidth);
  ...
  RS_INLINE void rsBiquadDesigner::calculateCookbookBandrejectCoeffsViaQ(double &b0, double &b1,
    double &b2, double &a1, double &a2, const double &oneOverSampleRate, const double &frequency,
    const double &q)
  {
    double sine, cosine;
  ...
  RS_INLINE void rsBiquadDesigner::calculateCookbookBandrejectCoeffsViaBandwidth(double &b0,
    double &b1, double &b2, double &a1, double &a2, const double &oneOverSampleRate,
    const double &frequency, const double &bandwidth)
  {
    double sine, cosine;
    calculateSineAndCosine(sine, cosine, frequency, oneOverSampleRate);
    double alpha = sine * sinh( 0.5*log(2.0) * bandwidth
  ...
  RS_INLINE void rsBiquadDesigner::calculateCookbookPeakFilterCoeffsViaQ(double &b0, double &b1,
    double &b2, double &a1, double &a2, const double &oneOverSampleRate, const double &frequency,
    const double &q, const double &gainFactor)
  {
    double sine, cosine;
  ...
  RS_INLINE void rsBiquadDesigner::calculateFirstOrderLowShelvCoeffs(double& b0, double& b1,
    double& b2, double& a1, double& a2, const double& oneOverSampleRate, const double& frequency,
    const double& gainFactor)
  {
    double A     = gainFactor;
  ...
  RS_INLINE void rsBiquadDesigner::calculateCookbookLowShelvCoeffs(double &b0, double &b1, 
    double &b2, double &a1, double &a2, const double &oneOverSampleRate, const double &frequency,
    const double &q, const double &gainFactor)
  {
    double sine, cosine;
  ...
  RS_INLINE void rsBiquadDesigner::calculateFirstOrderHighShelvCoeffs(double &b0, double &b1,
    double &b2, double &a1, double &a2, const double &oneOverSampleRate,
  ...
  RS_INLINE void rsBiquadDesigner::calculateCookbookHighShelvCoeffs(double &b0, double &b1,
    double &b2, double &a1, double &a2, const double &oneOverSampleRate, const double &frequency,
    const double &q, const double &gainFactor)
  {
    double sine, cosine;
  ...
  RS_INLINE void rsBiquadDesigner::calculateFirstOrderAllpassCoeffs(double &b0, double &b1,
    double &b2, double &a1, double &a2, const double &oneOverSampleRate, const double &frequency)
  {
  ...
  RS_INLINE void rsBiquadDesigner::calculateCookbookAllpassCoeffs(double &b0, double &b1, 
    double &b2, double &a1, double &a2, const double &oneOverSampleRate, const double &frequency,
    const double &q)
  {
    double sine, cosine;
  ...
  RS_INLINE void calculateLowHighpassChainCoeffs(double& b0, double& b1, double& b2,
    double& a1, double& a2, const double& oneOverSampleRate, const double& highpassCutoff,
    const double& lowpassCutoff)
  {
  ...
  RS_INLINE void rsBiquadDesigner::calculateLowPeakHighMorphCoeffs(double &b0, double &b1, 
    double &b2, double &a1, double &a2, double& preGain, const double &sampleRate,
    const double &oneOverSampleRate, const double &frequency, const double &q,
    const double &morph, const bool &scaleGainForTwoStages)
  {
  ...
  RS_INLINE void rsBiquadDesigner::calculatePrescribedNyquistGainEqCoeffs(double& b0,
    double& b1, double& b2, double& a1, double& a2, const double& oneOverSampleRate,
    ...
    const double& referenceGain)
  {
    ...
    double GB  = rsSqrt(G);                    // gain at bandedge frequencies
    ...
    double ta  = tan(w0/2);
    double W2  = rsSqrt(G11 / G00) * ta*ta;
    double DW  = (1 + rsSqrt(F00 / F11) * W2) * tan(Dw/2);
    double C   = F11 * DW*DW - 2 * W2 * (F01 - rsSqrt(F00 * F11));
    double D   = 2 * W2 * (G01 - rsSqrt(G00 * G11));
    double A   = rsSqrt((C + D) / F);
    double B   = rsSqrt((G*G * C + GB*GB * D) / F);
    double s   = 1.0 / (1 + W2 + A);
  ...
  RS_INLINE void rsBiquadDesigner::calculateOnePoleCoeffs(double& b0, double& b1, double& b2,
    double& a1, double& a2, const double& pole)
  {
    b0 = 1.0;
    b1 = 0.0;
  ...
  RS_INLINE void rsBiquadDesigner::calculateOneZeroCoeffs(double& b0, double& b1, double& b2,
    double& a1, double& a2, const double& zero)
  {
    b0 = 1.0;
    b1 = -zero;
  ...
  RS_INLINE void rsBiquadDesigner::calculatePolePairCoeffs(double& b0, double& b1, double& b2,
    double& a1, double& a2, const double& poleRadius, const double& poleAngle)
  {
    b0 = 1.0;
    b1 = 0.0;
  ...
  RS_INLINE void rsBiquadDesigner::calculateZeroPairCoeffs(double& b0, double& b1, double& b2,
    double& a1, double& a2, const double& zeroRadius, const double& zeroAngle)
  {
    b0 = 1.0;
