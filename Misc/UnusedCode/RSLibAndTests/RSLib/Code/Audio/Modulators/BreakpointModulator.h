#ifndef RS_BREAKPOINTMODULATOR_H
#define RS_BREAKPOINTMODULATOR_H
...
namespace RSLib
{
  ...
  */
  ...
  class RSLib_API rsBreakpointModulator
  {
  ...
  RS_INLINE double rsBreakpointModulator::getSample()
  {
