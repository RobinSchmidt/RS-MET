...
namespace rosic
{
  ...
  \todo: avoid references to the old MIDI standard
  ->rename this class into NoteEvent
  ->maybe have a more general class MusicalEvent (for general MIDI events)
  ->ControllerEvent, MetaParameterEvent, SyncTriggerEvent, TempoChangeEvent, ....
