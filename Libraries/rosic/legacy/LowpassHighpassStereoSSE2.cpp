...
LowpassHighpassStereoSSE2::LowpassHighpassStereoSSE2()
{
...
void LowpassHighpassStereoSSE2::setSampleRate(double newSampleRate)
{
...
void LowpassHighpassStereoSSE2::setLpfCutoff(double newLpfCutoff)
{
...
void LowpassHighpassStereoSSE2::setHpfCutoff(double newHpfCutoff)
{
...
void LowpassHighpassStereoSSE2::calcCoeffs()
{
...
void LowpassHighpassStereoSSE2::resetBuffers()
{
 // set all buffer variables to zero:
 x1 = _mm_set1_pd(0.0);
 x2 = _mm_set1_pd(0.0);
 y1 = _mm_set1_pd(0.0);
 y2 = _mm_set1_pd(0.0);
