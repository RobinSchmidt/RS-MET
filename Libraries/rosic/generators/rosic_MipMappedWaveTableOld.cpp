...
MipMappedWaveTableOld::MipMappedWaveTableOld()
{
...
void MipMappedWaveTableOld::setWaveform(double* newWaveForm, int lengthInSamples)
{
  int i;
...
void MipMappedWaveTableOld::setWaveform(int newWaveform)
{
...
void MipMappedWaveTableOld::removeDC()
{
...
void MipMappedWaveTableOld::normalize()
{
  // find maximum:
  double max = 0.0;
  int    i;
...
void MipMappedWaveTableOld::reverseTime()
{
  static intA i;
...
void MipMappedWaveTableOld::generateMultiSample()
{
...
void MipMappedWaveTableOld::fillWithSine()
{
...
void MipMappedWaveTableOld::fillWithTriangle()
{
  int i;
  for (i=0; i<(tableLength/4); i++)
...
void MipMappedWaveTableOld::fillWithPulse()
{
  int i;
...
void MipMappedWaveTableOld::fillWithSawUp()
{
  int i;
  for (i=0; i<(tableLength/2); i++)
...
void MipMappedWaveTableOld::fillWithSawDown()
{
  int i;
  for (i=0; i<(tableLength/2); i++)
    prototypeTable[i] = - (double)(2*i) / (double)(tableLength);
...
void MipMappedWaveTableOld::fillWithPeakUp()
{
  int i;
  for (i=0; i<(tableLength/2); i++)
...
void MipMappedWaveTableOld::fillWithPeakDown()
{
  int i;
  for (i=0; i<(tableLength/2); i++)
    prototypeTable[i] = -1 + (double)(2*i) / (double)(tableLength);
...
void MipMappedWaveTableOld::fillWithMoogSaw()
{
  // the sawUp part:
  int i;
  for (i=0; i<(tableLength/2); i++)
...
void MipMappedWaveTableOld::fillWithSqrMinusSin()
{
  fillWithPulse();
...
void MipMappedWaveTableOld::fillWithTriangleModulation()
{
...
void MipMappedWaveTableOld::fillWithBrownSineOcts()
{
...
void MipMappedWaveTableOld::fillWithSawOcts()
{
...
void MipMappedWaveTableOld::fillWithNoiseCycle(int noiseColor)
{
...
void MipMappedWaveTableOld::fillWithSineOcts(int NumOcts)
{
  //allocate buffer for the fundamental sine-wave:
  double sineBuffer[tableLength];
...
void MipMappedWaveTableOld::fillWithSineOctsAlt(int NumOcts)
{
  //allocate buffer for the fundamental sine-wave:
  double sineBuffer[tableLength];
...
void MipMappedWaveTableOld::fillWithTriangleOcts(int NumOcts)
{
...
void MipMappedWaveTableOld::fillWithTriangleOctsAlt(int NumOcts)
{
  //allocate buffer for the fundamental triangle-wave:
  double triangleBuffer[tableLength];
...
void MipMappedWaveTableOld::fillWithPulseOcts(int NumOcts)
{
...
void MipMappedWaveTableOld::fillWithPulseOctsAlt(int NumOcts)
{
  double pulseBuffer[tableLength];
  fillWithPulse();
  int i;
...
void MipMappedWaveTableOld::fillWithSawUpOcts(int NumOcts)
{
...
void MipMappedWaveTableOld::fillWithSawUpOctsAlt(int NumOcts)
{
  double sawUpBuffer[tableLength];
  fillWithSawUp();
  int i;
...
void MipMappedWaveTableOld::fillWithSawDownOcts(int NumOcts)
{
...
void MipMappedWaveTableOld::fillWithSawDownOctsAlt(int NumOcts)
{
  double sawDownBuffer[tableLength];
  fillWithSawDown();
  int i;
...
void MipMappedWaveTableOld::fillWithSquareSweep1()
{
...
void MipMappedWaveTableOld::fillWithSineSweepUp(double startFreq, double endFreq)
{
  static doubleA freqRatio, log2FreqRatio, freq;
  static intA i;

  freqRatio     = endFreq/startFreq;
  log2FreqRatio = log2(freqRatio);
...
void MipMappedWaveTableOld::fillWithSineSweepDown(double startFreq, double endFreq)
{
  static doubleA freqRatio, log2FreqRatio, freq;
  static intA i;
...
void MipMappedWaveTableOld::fillWithH1_4_7()
{
  // allocate buffer for the fundamental sine-wave:
  double sineBuffer[tableLength];
...
void MipMappedWaveTableOld::fillWithH2_5_8()
{
  //allocate buffer for the fundamental sine-wave:
  double sineBuffer[tableLength];
...
void MipMappedWaveTableOld::fillWithH3_6_9()
{
  // allocate buffer for the fundamental sine-wave:
  double sineBuffer[tableLength];
