...
namespace rosic
{
  ...
  This class implements a filter that approximates a (user-adjustable) constant slope in (dB/oct) across the whole audible range using two 
  second order shelving filters.
