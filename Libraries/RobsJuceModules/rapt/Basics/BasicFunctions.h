...
// twiddling. See RS-MET/Misc/UnusedCode/AISuggestions.txt for a suggestion for an optimized 
// implementation generated by GitHub Copilot. If we use this at some point, we should compare
// the results against the naive implementation above in a unit test.
