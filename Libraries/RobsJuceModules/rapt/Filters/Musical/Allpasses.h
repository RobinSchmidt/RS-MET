...
//
// - Make a rsTwoPoleAllpassDelayChain class similar to rsAllpassDelayChain
//
...
would look very similar - i.e. a lot code duplication and boilerplate. 
...Maybe get rid of it again. Or maybe at least move the convenience stuff to some higher level
library(part)
