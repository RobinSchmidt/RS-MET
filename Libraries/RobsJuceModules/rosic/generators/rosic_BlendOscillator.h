...
/** This is an oscillator that can continuously blend between two waveforms. This is more 
efficient than using two separate oscillators because the phase-accumulator has to be calculated 
