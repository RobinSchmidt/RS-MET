...
namespace rosic
{
  ...
  */
  ...
  class WorkhorseVoice : public PolyphonicInstrumentVoice
  {
  ...
  public:
    ...
    *outL1 and outL2 slots represent two subsequent (oversampled) samples for the left channel,
    ...
    WorkhorseOscSection oscSection;
  ...
  INLINE void WorkhorseVoice::getSampleFrameStereo(double *outL1, double *outR1,
    double *outL2, double *outR2, double *voiceAmplitude)
  {
    ...
    oscSection.getSampleFrameStereo(&osc1L, &osc1R);
