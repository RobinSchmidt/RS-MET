#ifndef TwoPoleBandpass_h
#define TwoPoleBandpass_h

#include "AudioModule.h"

/**

This is a 2-pole bandpass-filter which mimics a chain of a simple
RC-lowpass filter and a RC-highpass filter. One could use two objects
of class OnePole as well, but it's more convenient to have both filters
in one single object.

*/

class TwoPoleBandpass : public AudioModule
{
...
public:
 ...
 virtual void setLpfCutoff(double newLpfCutoff);
 ///< Sets the cutoff-frequency of the lowpass-filter.

 virtual void setHpfCutoff(double newHpfCutoff);
