#include "FeedbackDelayNetwork16.h"
...
void FeedbackDelayNetwork16::setOutputVector(int newOutputVectorIndex)
{
 ...
 case OUT_02:
  {
   c = (0.001*minDelayTime*sampleRate); // smallest delaytime in samples
 ...
 case PRIME_ALGO_1:
  {
   ...
   desiredDelays[ 2] = (17.0/11.0) * desiredDelays[0];
   desiredDelays[ 3] = (19.0/11.0) * desiredDelays[0];
   desiredDelays[ 4] = (23.0/11.0) * desiredDelays[0];
   desiredDelays[ 5] = (29.0/11.0) * desiredDelays[0];
   desiredDelays[ 6] = (31.0/11.0) * desiredDelays[0];
   desiredDelays[ 7] = (37.0/11.0) * desiredDelays[0];
   desiredDelays[ 8] = (41.0/11.0) * desiredDelays[0];
   desiredDelays[ 9] = (43.0/11.0) * desiredDelays[0];
   desiredDelays[10] = (47.0/11.0) * desiredDelays[0];
   desiredDelays[11] = (53.0/11.0) * desiredDelays[0];
   desiredDelays[12] = (59.0/11.0) * desiredDelays[0];
   desiredDelays[13] = (61.0/11.0) * desiredDelays[0];
   desiredDelays[14] = (67.0/11.0) * desiredDelays[0];
   desiredDelays[15] = (71.0/11.0) * desiredDelays[0];
  }
  break;
 ...
 case ALTERNATING:
  {
   ...
   delaysInSamples[ 1] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[15]);
   delaysInSamples[ 2] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[ 1]);
   delaysInSamples[ 3] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[14]);
   delaysInSamples[ 4] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[ 2]);
   delaysInSamples[ 5] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[13]);
   delaysInSamples[ 6] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[ 3]);
   delaysInSamples[ 7] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[12]);
   delaysInSamples[ 8] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[ 4]);
   delaysInSamples[ 9] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[11]);
   delaysInSamples[10] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[ 5]);
   delaysInSamples[11] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[10]);
   delaysInSamples[12] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[ 6]);
   delaysInSamples[13] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[ 9]);
   delaysInSamples[14] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[ 7]);
   delaysInSamples[15] 
    = primeNumbers.findClosestLowerPrime((int) desiredDelays[ 8]);
  }
  break;
...
void FeedbackDelayNetwork16::resetBuffers()
{
