...
namespace rosic
{
  ...
  */
  ...
  public:
    ...
    // \todo make them protected and either provide accessors or declare PolyphonicInstrument as friend
  ...
  protected:
    ...
    /** Variables to handle click-free amplitude changes when switching to a new key and/or velocity. */
    double targetLevel, targetAmplitude, currentLevel, currentAmplitude, levelIncPerSample, ampFactorPerSample, ampRampTime;
