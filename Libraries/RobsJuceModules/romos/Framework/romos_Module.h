...
protected:
  ...
  romos::ContainerModule *parentModule = nullptr;
  ...
  bool polyphonic = false;   // Flag to indicate that this module is polyphonic
  int  x = 0, y = 0;         // Position on the GUI block-diagram
  ...
  void (*processFrame) (Module *module, int voiceIndex) = nullptr;
  void (*processBlock) (Module *module, int voiceIndex, int blockSize) = nullptr;
