#ifndef jura_RTimeGridComboBox_h
#define jura_RTimeGridComboBox_h

/** This class is a RComboBox with pre-defined entries for choosing typical sync-intervals in
terms of whole notes. ...get rid of this class  */
...
public:
  ...
  /** Constructor. */
  RTimeGridComboBox(const juce::String& componentName = juce::String("RTimeGridComboBox"));
