...
FileSelectionBox::FileSelectionBox(const String& componentName, FileManager *fileManagerToUse)
{
  ...
  saveButton->setItemDescription(String("Save to file (save as)"));
  ...
  minusButton->setItemDescription(String("Skip to previous file in current directory"));
  ...
  plusButton->setItemDescription(String("Skip to next file in current directory"));
