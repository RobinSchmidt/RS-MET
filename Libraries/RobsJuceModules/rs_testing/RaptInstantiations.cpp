...
template class RAPT::rsMovingMaximumFilter<int>;
template class RAPT::rsMovingMaximumFilter<double>;
...
//template void rsArrayTools::softMax(const double* x, int N, double* y, double temperature);
...
template class rsDelayLineBasic<double>;
template class rsDelayLineBasic<RAPT::rsComplex<double>>;
template class rsDelayLineBasic<std::complex<double>>;
