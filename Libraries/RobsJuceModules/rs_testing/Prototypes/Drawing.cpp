...
void classifyFlatPixels3x3(const rsImageF& img, rsImage<char>& C, char F, float tol)
{
  ...
  // ToDo:
  // If all works well, maybe move this function as static member into rsPixelClassifier mainly to
  // demonstrate the usage by using flatness as example for a feature by which to classify pixels.
