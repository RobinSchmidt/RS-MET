...
the zero value of the respective class and write access out of range will have no effect. It acts 
as a non-owning wrapper (i.e. like a view) around an existing array.
...
see also rapt/Math/Functions/Mappers
