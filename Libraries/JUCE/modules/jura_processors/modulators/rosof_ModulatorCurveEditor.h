#ifndef rosof_ModulatorCurveEditor_h
#define rosof_ModulatorCurveEditor_h
...
namespace rosof
{
  ...
  This class is intended to be used as a graphical editor for a BreakpointModulator-object. Breakpoints can be created, removed and dragged 
  around.
  ...
  */
  ...
  class ModulatorCurveEditor	: virtual public CurveFamilyPlotOld, virtual public InteractiveCoordinateSystemOld, public ParameterObserver,
  ...
  public:
    ...
    /** Constructor. */
    ModulatorCurveEditor(const juce::String& name = juce::String(T("ModulatorCurveEditor")));   
    ...
    virtual bool setSelectedBreakpointShapeAmount(double newShapeAmount, bool broadcastMessage = false);

    /** Changes the shape all breakpoints at once. */
    virtual void setAllBreakpointShapeAmounts(double newShapeAmount, bool broadcastMessage = false);
    ...
    virtual CoordinateSystemRange 
      getMaximumMeaningfulRange(double relativeMarginLeft = 10.0, double relativeMarginRight  = 10.0,
      double relativeMarginTop  = 10.0, double relativeMarginBottom = 10.0);
    */
    ...
    virtual void updatePlotCurveData(int curveIndex, BreakpointModulator* modulator, 
      bool updateGUI);
  ...
  protected:
    ...
    virtual void plotBreakpoints(Graphics &g, Image *targetImage, BreakpointModulator* modulator, 
    ...
    plot. */
    virtual void plotLoopLocators(Graphics &g, Image *targetImage, BreakpointModulator* modulator, 
      const Colour& locatorColour, bool fullHeight = true);


    /** Pointer to the actual Modulator object which is being edited. */
    BreakpointModulator* modulatorToEdit;
