#ifndef jura_ModulatorCurveEditorMulti_h
#define jura_ModulatorCurveEditorMulti_h
...
public:
  ...
  /** Constructor. */
  ModulatorCurveEditorMulti(const juce::String& name = juce::String("ModulatorCurveEditorMulti"));
  ...
  virtual void addModulatorToEdit(RAPT::rsBreakpointModulator* newModulatorToEdit);
  ...
  /** Changes a colour for one of the curves - the index is assumed to exists in the array, if it's 
