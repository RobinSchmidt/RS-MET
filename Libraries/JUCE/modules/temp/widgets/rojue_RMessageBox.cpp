...
{
  headlineTextField = new RTextField( String(T("Message Box")) );
  ...
  bodyTextField = new RTextEditor(String(T("MessageBoxBodyTextEditor")));
  ...
  bodyTextField->setText( String(T("This is a box in which some message can be displayed")));
  addAndMakeVisible(bodyTextField);

  okButton = new RButton(String(T("OK")));
