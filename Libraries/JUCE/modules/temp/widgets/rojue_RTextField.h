#ifndef rojue_RTextField_h
#define rojue_RTextField_h
...
namespace rojue
{
  ...
  This class implements a simple textfield that can be shwon on the GUI.

  */

  class RTextField : public RWidget
  {
  ...
  class RTextEntryFieldObserver
  {

  public:

    /** This is called whenever the user has entered new text and finished his typing action via enter, escape or losing focus. */
    virtual void textChanged(RTextEntryField *rTextEntryFieldThatHasChanged) = 0;

    /** This is called whenever the user types in a new character, deletes a character or portion of the text or pastes a portion of text 
    from the clipboard but did not yet finish typing by pressing enter, escape or losing focus. You may override this when you want to be 
    informed about text-changes during typing - the default implementation does nothing. */
  ...
  */
  ...
  class RTextEntryField : public RTextField, public Timer
  {
  ...
  */
  ...
  class RLabeledTextEntryField : public RWidget
  {
  ...
  // \todo maybe make an RTextFieldWithModalEntryField, add comments and separator-lines in the cpp file
