#ifndef rojue_RMessageBox_h
#define rojue_RMessageBox_h
...
namespace rojue
{
  ...
  This class is a simple message box to display messages to the user - it can make itself invisible 
  by clicking on an OK button, so it can be used and re-used as a member of some class that needs 
  to display messages.
