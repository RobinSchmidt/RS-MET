#include "rojue_BitmapFontRoundedOutlineA10D0.h"
using namespace rojue;

BitmapFontRoundedOutlineA10D0::BitmapFontRoundedOutlineA10D0()
{
  ascent  = 10;
  descent = 0;
...
void BitmapFontRoundedOutlineA10D0::createGlyphBitmaps()
{
  float _ = 0.f;
  float X = 0.8f;
  float x = 0.65f;
