#include "rojue_BitmapFontBlockyA10D3.h"
...
void BitmapFontBlockyA10D3::createGlyphBitmaps()
{
  float _ = 0.f;
  float X = 1.f;
  ...
  glyphBitmaps[102] = new ColourizableBitmap(5, 13, glyph_f);
  ...
  glyphBitmaps[103] = new ColourizableBitmap(6, 13, glyph_g);
  ...
  glyphBitmaps[106] = new ColourizableBitmap(4, 13, glyph_j);
  ...
  glyphBitmaps[112] = new ColourizableBitmap(6, 13, glyph_p);
  ...
  glyphBitmaps[113] = new ColourizableBitmap(6, 13, glyph_q);
  ...
  glyphBitmaps[121] = new ColourizableBitmap(6, 13, glyph_y);
