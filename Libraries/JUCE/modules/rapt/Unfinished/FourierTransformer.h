#ifndef RS_FOURIERTRANSFORMERRADIX2_H
#define RS_FOURIERTRANSFORMERRADIX2_H
...
namespace RSLib
{
  ...
  rsComplex). The length of the block has to be a power of 2.

  \todo rename file to FourierTransformer

  */

  class RSLib_API rsFourierTransformerRadix2  
  {
  ...
  */
  ...
  class RSLib_API rsFourierTransformerBluestein  
  {
