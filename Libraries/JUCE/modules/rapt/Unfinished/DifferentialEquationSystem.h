#ifndef RS_DIFFERENTIALEQUATIONSYSTEM_H
#define RS_DIFFERENTIALEQUATIONSYSTEM_H
...
namespace RSLib
{
  ...
  */
  ...
  typedef rsDifferentialEquationSystem<double, double> RSLib_API rsDifferentialEquationSystemDbl;
