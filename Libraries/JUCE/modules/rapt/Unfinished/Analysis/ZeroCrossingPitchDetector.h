#ifndef RS_PITCHDETECTOR_H
#define RS_PITCHDETECTOR_H
...
namespace RSLib
{
  ...
  rename into ZeroCrossingPitchDetector

  */

  class RSLib_API rsZeroCrossingPitchDetector
  {
  ...
  public:
    ...
    RS_INLINE double estimatePeriod(double inputSignal);
    ...
    RS_INLINE double estimatePeriod(double inputSignal, double whiteSignal);

    /** Estimates and returns the fundamental frequency of the incoming signal (in Hz). */
    RS_INLINE double estimateFundamentalFrequency(double inputSignal);

    /** Estimates and returns the pitch of the incoming signal (in terms of a midi note number). */
    RS_INLINE double estimatePitch(double inputSignal);
    ...
    void reset(double initialEstimate = 1000.0);
  ...
  RS_INLINE double rsZeroCrossingPitchDetector::estimatePeriod(double inputSignal)
  {
  ...
  RS_INLINE double rsZeroCrossingPitchDetector::estimatePeriod(double inputSignal, double whiteSignal)
  { 
  ...
  RS_INLINE double rsZeroCrossingPitchDetector::estimateFundamentalFrequency(double inputSignal)
  {
    estimatePeriod(inputSignal);
    return frequencyEstimate;
  }

  RS_INLINE double rsZeroCrossingPitchDetector::estimatePitch(double inputSignal)
  { 
  ...
  RS_INLINE double rsZeroCrossingPitchDetector::getFractionalPartOfZeroCrossing()
  {
    ...
    return RSLib::getCubicRootNear(fracLinear, a, b, c, d, 0.0, 1.0);
  }
