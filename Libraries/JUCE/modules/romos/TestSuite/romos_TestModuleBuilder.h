...
namespace romos
{
  ...
  This class contains a bunch of static functions that create and return a pointer to modules that are programmatically created. They are 
  intended to be used for automated unit test and demonstrate the usage of the framework. The caller must take care to eventually delete 
  the returned modules again.
