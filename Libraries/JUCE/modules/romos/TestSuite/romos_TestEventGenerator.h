...
namespace romos
{
  ...
  */
  ...
  public:
    ...
    static std::vector<NoteEvent> generateNoteOnOffPair(unsigned int key, unsigned int velocity, 
    ...
    static std::vector<NoteEvent> generateSimultaneousNotes(unsigned int key, unsigned int velocity, 
      unsigned int deltaFramesForNoteOn, unsigned int durationInFrames,
    ...
    static std::vector<NoteEvent> mergeEvents(const std::vector<NoteEvent> &eventArray1, const std::vector<NoteEvent> &eventArray2);
    ...
    static void convertNoteEventsToStartsAndDurations(const std::vector<NoteEvent> &events, std::vector<NoteEvent> &noteOns, 
    ...
    static int findIndexOfMatchingNoteOff(const std::vector<NoteEvent> &events, NoteEvent noteOnEvent);

    /** Sorts the passed sequence of events by time of occurence. */
    static void sortEventsByTimeOfOccurence(const std::vector<NoteEvent> &eventArray);
