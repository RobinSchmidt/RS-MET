...
namespace romos
{
  ...
  This class serves as the high-level interface for running all the unit-tests for the romos library. To run all the tests, you simply 
  create an insteance of this class and call runAllTestsAndPrintResultsToConsole() on it. You can also selectively run only certain tests 
  by using the other runXxxxTests methods.
