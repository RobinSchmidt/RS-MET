...
{
  processModuleInFrames();
  copyBuffer(outputs[0][0], desiredOutputs[0][0], numFramesToProcess);
  copyBuffer(outputs[0][1], desiredOutputs[0][1], numFramesToProcess);
  copyBuffer(outputs[0][2], desiredOutputs[0][2], numFramesToProcess);
}
