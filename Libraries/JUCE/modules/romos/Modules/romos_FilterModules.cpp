...
namespace romos
{
  ...
  INLINE void LadderFilter::process(Module *module, double *in1, double *in2, double *in3, double *in4, double *out, int voiceIndex)
  {
    ...
    // maybe use a function pointer later that is assigned in parameterChanged - check which version is more efficient
