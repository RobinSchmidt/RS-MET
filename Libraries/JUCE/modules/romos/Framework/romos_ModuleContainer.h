...
namespace romos
{
  ...
  */
  ...
  public:
    ...
    /** Switches polyphony for this module on or off. For containers, this means that the poly-flag will be set for the container itself
    as well as its input- and output modules. */
    ...
    /** Overriden from Module to additionaly set up the pin-data in the input-module that corresponds to the given pin-index. */
    ...
    /** Deletes a bunch of embedded module from this one (these can be child modules or in-/out moduels). */
    ...
    /** Extracts all container modules in the passed array and puts their content modules as direct child-modules of "this" one. */
    ...
    /** Returns true when all child-modules (including I/O modules) are monophonic, false otherwise. */
    ...
    /** Returns a vector of modules that are connected as target-modules to the given source-module. */
  ...
  protected:
    ...
    /** Checks whether or not the passed module is among our direct child modules (including in/out modules). */
    ...
    //rosic::Array<Module*> childModules;
