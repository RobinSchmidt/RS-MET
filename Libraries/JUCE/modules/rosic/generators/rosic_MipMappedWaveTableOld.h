...
namespace rosic
{
  ...
  */
  ...
  public:
    ...
    /** Returns the value at position "phaseIndex" of table "tableIndex" with hermite 
    interpolation */
  ...
  INLINE double MipMappedWaveTableOld::getValueLinear(double phaseIndex, int tableIndex)
  {
  ...
  INLINE double MipMappedWaveTableOld::getValueHermite(double phaseIndex, int tableIndex)
  {
    static doubleA floorOfIndex, fracIndex;
...
#endif // rosic_MipMappedWaveTableOld_h
