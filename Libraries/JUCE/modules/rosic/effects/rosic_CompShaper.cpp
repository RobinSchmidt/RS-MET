...
void CompShaper::setKneeWidth(double newKneeWidth)
{
  if( newKneeWidth >= 0.0 )
  {
...
void CompShaper::setKneeShape(int newKneeShape)
{
...
void CompShaper::calculateCoefficients()
{
  if( kneeShape == CUBIC )
...
void CompShaper::calculateCubicCoefficients()
{
  double x1  = threshold - 0.5*kneeWidth*0.01*threshold;
  double y1  = threshold - 0.5*kneeWidth*0.01*threshold;
  double yd1 = 1.0;
  double x2  = threshold + 0.5*kneeWidth*0.01*threshold;
  double y2  = threshold + (1.0/ratio)*(0.5*kneeWidth*0.01*threshold);
