...
/** This class implements a TwoPole filter which can be used as band in a serial equalizer. For 
peak filter mode, the filter is designed by Sophocles Orfanidis' design procedure to match the 
magnitude of an analog equalizer at the Nyquist frequency. */
...
/** Returns the lower bandedge frequency (defined at the half dB-gain point). */
  ...
  /** Converts a lower bandedge-frequency into the corresponding bandwidth (in octaves) for a 
  given center frequency. */
  static double lowerBandedgeFrequencyToBandwdith(double lowerBandEdgefrequency, 
    double centerFrequency);

  /** Converts an upper bandedge-frequency into the corresponding bandwidth (in octaves) for a 
  given center frequency. */
  static double upperBandedgeFrequencyToBandwdith(double upperBandEdgefrequency, 
    double centerFrequency);
