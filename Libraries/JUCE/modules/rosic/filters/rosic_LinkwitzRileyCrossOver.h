...
namespace rosic
{
  ...
  */
  ...
  public:
    ...
    /** Sets the slope of the filters - this must be a multiple of 12 (\todo allow also for 6 dB/oct). */
    ...
    /** Calculates a pair of lowpass/highpass output samples from a (presumbaly) broadband input signal. */
  ...
  INLINE void LinkwitzRileyCrossOver::getSamplePair(double *in, double *outLow,  double *outHigh)
  {
    double tmp  = *in;
  ...
  INLINE void LinkwitzRileyCrossOver::processBuffer(double *in, double *outLow, double *outHigh, int length)
  {
    double tmp;
  ...
  INLINE void LinkwitzRileyCrossOver::processBuffer(float *in, float *outLow, float *outHigh, int length)
  {
    float tmp;
    for(int n=0; n<length; n++)
    {
  ...
  */
  ...
  public:
    ...
    /** Switches the crossover on/off. When off, the input signal is passed through to the lowpass output and the highpass output will be
    empty (zero). */
    ...
    /** Switches into mono-mode where only the left channel is calculated and the copied into the right output channel. */
    ...
    INLINE void getSampleFrame(double *inL, double *inR, double *outLowL, double *outLowR, double *outHighL, double *outHighR);
    INLINE void getSampleFrame(float  *inL, float  *inR, float  *outLowL, float  *outLowR, float  *outHighL, float  *outHighR);

    /** Processes a buffer of samples. */
    INLINE void processBuffer(double *inL, double *inR, double *outLowL, double *outLowR, double *outHighL, double *outHighR, int length);
    INLINE void processBuffer(float  *inL, float  *inR, float  *outLowL, float  *outLowR, float  *outHighL, float  *outHighR, int length);
