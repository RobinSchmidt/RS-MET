#ifndef MagicCarpetOscillator_h
#define MagicCarpetOscillator_h
...
protected:
 ...
 double* tableR;              // pointer to the (integrated) wave-table for L
...
INLINE void MagicCarpetOscillator::setFrequency(double newFrequency)
{
 if( newFrequency > 0 )
  freq = newFrequency;
...
INLINE void MagicCarpetOscillator::getSampleFrameStereo(double* outL, 
                                                        double* outR)
{
 double tmpL, tmpR;
