...
namespace
    ...
    class abs_FunctionNode : public FunctionNode
        {
        public:
            abs_FunctionNode::abs_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
    ...
    class mod_FunctionNode : public FunctionNode
        {
        public:
            mod_FunctionNode::mod_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
    ...
    class ipart_FunctionNode : public FunctionNode
        {
        public:
            ipart_FunctionNode::ipart_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class fpart_FunctionNode : public FunctionNode
        {
        public:
            fpart_FunctionNode::fpart_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class min_FunctionNode : public FunctionNode
        {
        public:
            min_FunctionNode::min_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
    ...
    class max_FunctionNode : public FunctionNode
        {
        public:
            max_FunctionNode::max_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(2, -1, 0, 0);
                }
    ...
    class sqrt_FunctionNode : public FunctionNode
        {
        public:
            sqrt_FunctionNode::sqrt_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class sin_FunctionNode : public FunctionNode
        {
        public:
            sin_FunctionNode::sin_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class cos_FunctionNode : public FunctionNode
        {
        public:
            cos_FunctionNode::cos_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class tan_FunctionNode : public FunctionNode
        {
        public:
            tan_FunctionNode::tan_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class sinh_FunctionNode : public FunctionNode
        {
        public:
            sinh_FunctionNode::sinh_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class cosh_FunctionNode : public FunctionNode
        {
        public:
            cosh_FunctionNode::cosh_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class tanh_FunctionNode : public FunctionNode
        {
        public:
            tanh_FunctionNode::tanh_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class asin_FunctionNode : public FunctionNode
        {
        public:
            asin_FunctionNode::asin_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class acos_FunctionNode : public FunctionNode
        {
        public:
            acos_FunctionNode::acos_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class atan_FunctionNode : public FunctionNode
        {
        public:
            atan_FunctionNode::atan_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class atan2_FunctionNode : public FunctionNode
        {
        public:
            atan2_FunctionNode::atan2_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(2, 2, 0, 0);
                }
    ...
    class log_FunctionNode : public FunctionNode
        {
        public:
            log_FunctionNode::log_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class ln_FunctionNode : public FunctionNode
        {
        public:
            ln_FunctionNode::ln_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class exp_FunctionNode : public FunctionNode
        {
        public:
            exp_FunctionNode::exp_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class logn_FunctionNode : public FunctionNode
        {
        public:
            logn_FunctionNode::logn_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(2, 2, 0, 0);
                }
    ...
    class ceil_FunctionNode : public FunctionNode
        {
        public:
            ceil_FunctionNode::ceil_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class floor_FunctionNode : public FunctionNode
        {
        public:
            floor_FunctionNode::floor_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class rand_FunctionNode : public FunctionNode
        {
        public:
            rand_FunctionNode::rand_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
    ...
    class random_FunctionNode : public FunctionNode
        {
        public:
            random_FunctionNode::random_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
    ...
    class randomize_FunctionNode : public FunctionNode
        {
        public:
            randomize_FunctionNode::randomize_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(0, 0, 1, 1);
                }
    ...
    class deg_FunctionNode : public FunctionNode
        {
        public:
            deg_FunctionNode::deg_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class rad_FunctionNode : public FunctionNode
        {
        public:
            rad_FunctionNode::rad_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
    ...
    class rect2pol_FunctionNode : public FunctionNode
        {
        public:
            rect2pol_FunctionNode::rect2pol_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
    ...
    class pol2rect_FunctionNode : public FunctionNode
        {
        public:
            pol2rect_FunctionNode::pol2rect_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(2, 2, 2, 2);
                }
    ...
    class if_FunctionNode : public FunctionNode
        {
        public:
            if_FunctionNode::if_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
    ...
    class select_FunctionNode : public FunctionNode
        {
        public:
            select_FunctionNode::select_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
    ...
    class equal_FunctionNode : public FunctionNode
        {
        public:
            equal_FunctionNode::equal_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(2, 2, 0, 0);
                }
    ...
    class above_FunctionNode : public FunctionNode
        {
        public:
            above_FunctionNode::above_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(2, 2, 0, 0);
                }
    ...
    class below_FunctionNode : public FunctionNode
        {
        public:
            below_FunctionNode::below_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(2, 2, 0, 0);
                }
    ...
    class clip_FunctionNode : public FunctionNode
        {
        public:
            clip_FunctionNode::clip_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(3, 3, 0, 0);
                }
    ...
    class clamp_FunctionNode : public FunctionNode
        {
        public:
            clamp_FunctionNode::clamp_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(3, 3, 0, 0);
                }
    ...
    class rescale_FunctionNode : public FunctionNode
        {
        public:
            rescale_FunctionNode::rescale_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
    ...
    class poly_FunctionNode : public FunctionNode
        {
        public:
            poly_FunctionNode::poly_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(2, -1, 0, 0);
                }
    ...
    class and_FunctionNode : public FunctionNode
        {
        public:
            and_FunctionNode::and_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(2, 2, 0, 0);
                }
    ...
    class or_FunctionNode : public FunctionNode
        {
        public:
            or_FunctionNode::or_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(2, 2, 0, 0);
                }
    ...
    class not_FunctionNode : public FunctionNode
        {
        public:
            not_FunctionNode::not_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(1, 1, 0, 0);
                }
