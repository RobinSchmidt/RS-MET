#ifndef jura_InteractiveCoordinateSystem_h
#define jura_InteractiveCoordinateSystem_h
...
public:
  ...
  virtual XmlElement* getStateAsXml(
    const juce::String& stateName = juce::String("InteractiveCoordinateSystemState")) const;
