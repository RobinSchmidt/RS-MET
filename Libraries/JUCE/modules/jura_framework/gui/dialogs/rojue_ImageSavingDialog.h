#ifndef rojue_ImageSavingDialog_h
#define rojue_ImageSavingDialog_h
...
namespace rojue
{
  ...
  This class is to be used as content component for a DialogWindow object for saving images - it is 
  mainly intended to export the contents of a Component to image files.
  ...
  */
  ...
  public:
    ...
    ImageSavingDialog(CoordinateSystemOld *owner = NULL, int defaultWidth = 320, 
      int defaultHeight = 320, const String &defaultFormat = String(T("png")),  
