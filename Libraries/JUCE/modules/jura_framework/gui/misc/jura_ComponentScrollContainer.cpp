...
{
  autoDeleteScrollee = deleteScrolleeInDestructor;
...
void ComponentScrollContainer::scrollBarMoved(RScrollBar* scrollBarThatHasMoved, 
...
void ComponentScrollContainer::componentMovedOrResized(Component &component, bool wasMoved, 
  bool wasResized)
{
...
void ComponentScrollContainer::updateScrollBarBoundsAndVisibility()
{
  ...
  // interrelated in a somewhat messy way...
  ...
  {
    upDownScrollBar->setBounds(getWidth()-scrollBarThickness, 0, scrollBarThickness, 
      availableHeight+RWidget::outlineThickness);
    leftRightScrollBar->setBounds(0, getHeight()-scrollBarThickness, 
      availableWidth+RWidget::outlineThickness, scrollBarThickness);
    bottomRightCoverage->setBounds(getWidth()-scrollBarThickness, getHeight()-scrollBarThickness, 
