#ifndef rojue_InteractiveCoordinateSystemOld_h
#define rojue_InteractiveCoordinateSystemOld_h
...
namespace rojue
{
  ...
  This class is a CoordinateSystemOld with an array CoordinatesystemControlHandles which - in their 
  ...
  */
  ...
  class InteractiveCoordinateSystemOld	: virtual public CoordinateSystemOld
  {
  ...
  public:
    ...
    virtual XmlElement* getStateAsXml(
      const juce::String& stateName = juce::String(T("InteractiveCoordinateSystemOldState"))) const;
