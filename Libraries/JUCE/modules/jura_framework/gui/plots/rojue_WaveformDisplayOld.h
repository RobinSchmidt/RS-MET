#ifndef rojue_WaveformDisplayOld_h
#define rojue_WaveformDisplayOld_h

#include "rojue_CurveFamilyPlotOld.h"
...
namespace rojue
{
  ...
  */
  ...
  public:
    ...
    WaveformDisplayOld(const juce::String& name = juce::String(T("WaveformDisplayOld")));   
    /**< Constructor. */
