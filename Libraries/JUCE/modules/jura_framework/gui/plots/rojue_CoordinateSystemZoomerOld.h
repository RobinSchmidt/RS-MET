#ifndef rojue_CoordinateSystemZoomerOld_h
#define rojue_CoordinateSystemZoomerOld_h
...
namespace rojue
{
  ...
  This a class for a CoordinateSystemOld with zooming and scrolling capabilities. It has a pointer 
  to the actual CoordinateSystemOld (or some subclass thereof) object for which the zooming and 
  ...
  */
  ...
  class CoordinateSystemZoomerOld : public ColourSchemeComponent, public RButtonListener, public RScrollBarListener
  {
  ...
  public:
    ...
    /**< This function should be used to pass the CoordinateSystemOld-object (or an 
    object of some subclass thereof) which should be shown, zoomed and 
    scrolled. */

    virtual void invalidateCoordinateSystemPointer();
    /**< This function should be called when the CoordinateSystemOld, to which we
