#ifndef rojue_MessengingCoordinateSystemOld_h
#define rojue_MessengingCoordinateSystemOld_h
...
namespace rojue
{
  ...
  */
  ...
  public:
    ...
    MessengingCoordinateSystemOld(const juce::String &name = juce::String(T("MessangingCoordinateSytem"))); 
